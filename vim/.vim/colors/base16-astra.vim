...
" Astra scheme by Andrew Goudzwaard (@adgoudz)
...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-astra.sh"
  endif
endif

" GUI color definitions
let s:gui00        = "1d1d1d"
let g:base16_gui00 = "1d1d1d"
let s:gui01        = "282a2e"
...
let s:gui05        = "bfd0d2"
let g:base16_gui05 = "bfd0d2"
let s:gui06        = "fdf6e3"
let g:base16_gui06 = "fdf6e3"
let s:gui07        = "ffffff"
...
hi clear
syntax reset
let g:colors_name = "base16-astra"
...
call <sid>hi("Exception",     s:gui08, "", s:cterm07, "", "", "")
call <sid>hi("FoldColumn",    s:gui0C, s:gui01, s:cterm0C, s:cterm01, "", "")
call <sid>hi("Folded",        s:gui03, s:gui01, s:cterm03, s:cterm01, "", "")
call <sid>hi("IncSearch",     s:gui07, s:gui02, s:cterm07, s:cterm02, "none", "")
...
call <sid>hi("Search",        s:gui07, s:gui02, s:cterm07, s:cterm02,  "", "")
call <sid>hi("Substitute",    s:gui01, s:gui09, s:cterm01, s:cterm09, "none", "")
call <sid>hi("SpecialKey",    s:gui03, "", s:cterm03, "", "", "")
call <sid>hi("TooLong",       s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("Underlined",    s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("Visual",        s:gui07, s:gui01, s:cterm07, s:cterm01, "", "")
call <sid>hi("VisualNOS",     s:gui07, s:gui01, s:cterm07, s:cterm01, "", "")
...
call <sid>hi("LineNr",        s:gui03, s:gui00, s:cterm02, s:cterm00, "", "")
call <sid>hi("SignColumn",    s:gui03, s:gui01, s:cterm03, s:cterm01, "", "")
call <sid>hi("StatusLine",    s:gui04, s:gui01, s:cterm04, s:cterm01, "none", "")
call <sid>hi("StatusLineNC",  s:gui03, s:gui01, s:cterm03, s:cterm01, "none", "")
call <sid>hi("VertSplit",     s:gui01, s:gui01, s:cterm01, "", "none", "")
...
call <sid>hi("PreProc",      s:gui0C, "", s:cterm0C, "", "", "")
call <sid>hi("Repeat",       s:gui09, "", s:cterm0E, "", "", "")
call <sid>hi("Special",      s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("SpecialChar",  s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("Statement",    s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("StorageClass", s:gui09, "", s:cterm0E, "", "", "")
call <sid>hi("String",       s:gui0C, "", s:cterm0C, "", "", "")
call <sid>hi("Structure",    s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("Tag",          s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("Todo",         s:gui09, s:gui01, s:cterm09, s:cterm01, "", "")
call <sid>hi("Type",         s:gui0D, "", s:cterm0D, "", "none", "")
call <sid>hi("Typedef",      s:gui09, "", s:cterm0E, "", "", "")

call <sid>hi("helpNote",         s:gui08, "", s:cterm08, "", "", "") " Added
...
call <sid>hi("gitcommitBranch",         s:gui06, "", s:cterm06, "", "", "")
call <sid>hi("gitcommitUntrackedFile",  s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("gitcommitUnmergedFile",   s:gui08, "", s:cterm08, "", "bold", "")
call <sid>hi("gitcommitDiscardedFile",  s:gui04, "", s:cterm04, "", "", "")
...
" HTML highlighting
call <sid>hi("htmlBold",    s:gui09, "", s:cterm09, "", "", "")
...
call <sid>hi("jsGlobalObjects",     s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("jsGlobalNodeObjects", s:gui09, "", s:cterm09, "", "", "")
...
call <sid>hi("mailQuoted6",  s:gui09, "", s:cterm09, "", "", "")
...
call <sid>hi("NERDTreeLinkFile",  s:gui0E, "", s:cterm0E, "", "", "") " Added
call <sid>hi("NERDTreeLinkDir",  s:gui0E, "", s:cterm0E, "", "", "") " Added
